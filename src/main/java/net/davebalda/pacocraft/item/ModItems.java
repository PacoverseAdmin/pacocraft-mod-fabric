...
public class ModItems {
    ...
    public static final Item ABOMINEM_SPAWN_EGG = registerItem("abominem_spawn_egg",
            new SpawnEggItem(ModEntities.ABOMINEM, 0xb8acac, 0xa11e1e, new FabricItemSettings()));
